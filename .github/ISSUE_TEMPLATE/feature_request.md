...
What Category does this address: 
- [ ] Data Ingestion, 
- [ ] Visualization, 
- [ ] Alerting, 
- [ ] Collaboration,
...
- [ ] Security and Access,
- [ ] Usuability
_To checkmark the box in markdown replace the space in `- [ ]` with an x `- [x]`_

*In a sentence or two, tell us what could be added or what could be better.*  
...
*What change or result would let you say “Yes — this works”?” | Acceptance Crit*  
